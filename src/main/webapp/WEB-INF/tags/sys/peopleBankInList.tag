...
<script type="text/javascript">
	...
	function computeAmount(vId,vKbn){
		...
		var moneyCountDId = "moneyCountD_" + vId;		//未复点(捆)-数量列1
		var moneyCountYId = "moneyCountY_" + vId;		//已复点(捆)-数量列2
...
<table  id="contentTable" class="table table-hover">
	<thead>
		<tr>
			...
			<!-- 未复点(捆) -->
			<th style="text-align:center;"><spring:message code="clear.public.nonePoint"/>(<spring:message code="clear.public.bundle"/>)</th>
			<!-- 已复点(捆) -->
			<th style="text-align:center;"><spring:message code="clear.public.havePoint"/>(<spring:message code="clear.public.bundle"/>)</th>
			<!-- 金额(元)-->
