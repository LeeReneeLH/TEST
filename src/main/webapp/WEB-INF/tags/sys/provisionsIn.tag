...
<script type="text/javascript">
	...
	function computeAmount(vId,vKbn){
		...
		var moneyCountDId = "moneyCountD_" + vId;		//数量(张)-数量列1
	...
	function setSumDiff() {
		//取得一列的合计值
		var sumCountD = getSumValue('CountD');			//数量(张)
...
<table  id="contentTable" class="table table-hover">
	<thead>
		<tr>
			...
			<!-- 数量(张) -->
			<th style="text-align:center;"><spring:message code='common.number'/>(<spring:message code='clear.public.zhang'/>)</th>
			<!-- 金额(元)-->
