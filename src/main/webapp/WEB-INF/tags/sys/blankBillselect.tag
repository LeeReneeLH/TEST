...
function makeBlankBillKindOptions(){
	var url = '${ctx}/store/v01/stoRelevance/getBlankBillKindList';
...
function makeBlankBillTypeOptions(){
	var url = '${ctx}/store/v01/stoRelevance/getBlankBillTypeList';
	var stoBlankBillSelect = {};
	//stoBlankBillSelect.blankBillKind = $("#blankBillKind").val();
	if($("#blankBillKind").select2("data")){
		stoBlankBillSelect.kindRefCode = $("#blankBillKind").select2("data").refCode;
	}
...
<div class="control-group item" >
	...
	<div class="controls" style="margin-left:130px; width:270px;">
		<form:input id="blankBillKind" path="stoBlankBillSelect.blankBillKind" class="required"/>
...
<div class="control-group item">
	...
	<div class="controls" style="margin-left:130px; width:270px;">
		<form:input id="blankBillType" path="stoBlankBillSelect.blankBillType" class="required"/>
		<span class="help-inline"><font color="red">*</font> </span>
	</div>
</div>
<div class="clear"></div>
