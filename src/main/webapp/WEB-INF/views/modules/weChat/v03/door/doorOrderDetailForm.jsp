...
<body>
	<ul class="nav nav-tabs">
		<!-- 存款列表 -->
		<li id="disLi1"><a onclick="window.top.clickSelect();" href="${ctx}/weChat/v03/doorOrderInfo/"><spring:message code="door.doorOrder.deposit" /><spring:message code="common.list" /></a></li>
		<!-- 存款查看 -->
