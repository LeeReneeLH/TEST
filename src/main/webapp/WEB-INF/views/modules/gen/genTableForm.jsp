			...
			<form:form id="inputForm" modelAttribute="genTable" action="${ctx}/gen/genTable/form" method="post" class="form-horizontal">
				...
				<div class="control-group">
					...
					<div class="form-actions">
						...
						<a href ="${ctx}/gen/genTable/back"><input id="btnCancel" class="btn" type="button" value="返 回"/></a>
					</div>
				</div>
			</form:form>
		</c:when>
		<c:otherwise>
			<form:form id="inputForm" modelAttribute="genTable" action="${ctx}/gen/genTable/save" method="post" class="form-horizontal">
				...
				<div class="form-actions">
					...
					<input id="btnCancel" class="btn" type="button" value="返 回" onclick = "window.location.href ='${ctx}/gen/genTable/back'"/>
				</div>
			</form:form>
		</c:otherwise>
	</c:choose>
