...
<body>
	...
	<div class="row">
		<form:form id="submitForm" modelAttribute="stoEscortInfo" method="post"
			class="form-horizontal" enctype="multipart/form-data" 
			action="${ctx}/store/v01/stoEscortInfo/uploadAndSaveImage">
			<%-- 请选择小于1M的图片后，点击保存。 --%>
			<h1>
	...
	<div id="targetImgDiv">
		<img id="target" src="${ctx}/store/v01/stoEscortInfo/showImage?id=${stoEscortInfo.id}" >
	</div>
