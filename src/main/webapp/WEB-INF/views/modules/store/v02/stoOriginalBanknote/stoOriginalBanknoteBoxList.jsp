...
<body>
	...
	<form:form id="searchForm" modelAttribute="stoOriginalBanknote" action="${ctx}/v02/stoOriginalBanknote/boxList" method="post" class="breadcrumb form-search">
	...
	<div class="row">
		...
		<div class="span">
			...
			<form:input path="createName" htmlEscape="false" maxlength="100" class="input-medium"/>
		</div>
		<div class="span">
			<!-- 入库日期 -->
	...
	<div class="row" style="margin-top:10px">
		...
		<div class="span">
			...
			<label><form:input path="outName" htmlEscape="false" maxlength="100" class="input-medium"/></label>
		</div>
		<div class="span">
			<!-- 出库日期 -->
			<label><spring:message code="store.original.outDate"/>：</label>
			<label><input id="outDate"  name="outDate" type="text" readonly="readonly" maxlength="20" class="input-small Wdate createTime" 
	...
	<table id="contentTable" class="table  table-hover">
		<thead>
			<tr>
				...
				<!-- 是否回收 -->
				<th><spring:message code="store.original.isOrNo"/></th>
				<!-- 上缴机构 -->
				<th><spring:message code="store.original.recoverOffice"/></th>
				<!-- 上缴时间 -->
				<th><spring:message code="store.original.recoverDate"/></th>
			</tr>
		</thead>
		<tbody>
		<c:forEach items="${page.list}" var="stoOriginalBanknote" varStatus="status">
			<tr>
				...
				<td>${stoOriginalBanknote.coffice.name}</td>
				...
				<td><fmt:formatDate value="${stoOriginalBanknote.recoverDate}" pattern="yyyy-MM-dd" /></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
