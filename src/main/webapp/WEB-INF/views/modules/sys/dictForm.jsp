...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules: {
					value: {remote: {url:"${ctx}/sys/dict/checkDictValue",data:{value:function(){return $("#value").val()},type:function(){return $("#type").val()}}}}
				},
				messages: {
					value: {remote: "该类型键值已存在，请重新输入"},
				},
...
<body>
	...
	<form:form id="inputForm" modelAttribute="dict" action="${ctx}/sys/dict/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="value" htmlEscape="false" maxlength="50" class="required abc" disabled="${empty dict.id ? false : true}"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="type" htmlEscape="false" maxlength="50" class="required abc" disabled="${empty dict.id ? false : true}"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="cssStyle" htmlEscape="false"/>
			</div>
		</div>
		<div class="control-group">
			<label class="control-label">CSS类:</label>
			<div class="controls">
				<form:input path="cssClass" htmlEscape="false"/>
			</div>
		</div>
		<div class="form-actions">
			...
			<input id="btnCancel" class="btn" type="button" value="返 回" onclick = "window.location.href ='${ctx}/sys/dict/back'"/>
		</div>
	</form:form>
</body>
</html>