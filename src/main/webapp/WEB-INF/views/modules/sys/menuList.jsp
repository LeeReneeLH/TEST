			...
			<tbody><c:forEach items="${list}" var="menu">
				<tr id="${menu.id}" pId="${menu.parent.id ne '1'?menu.parent.id:'0'}">
					...
					<shiro:hasPermission name="sys:menu:edit"><td nowrap>
						<a href="${ctx}/sys/menu/form?id=${menu.id}" title='修改' style="margin-right:10px;"><i class="fa fa-edit text-green fa-lg"></i></a>
						<a href="${ctx}/sys/menu/delete?id=${menu.id}" onclick="return confirmx('要删除该菜单及所有子菜单项吗？', this.href)" title='删除' style="margin-right:10px;"><i class="fa fa-trash-o text-red fa-lg"></i></a>
						<a href="${ctx}/sys/menu/form?parent.id=${menu.id}" title='添加下级菜单'><i class="fa fa-plus-square-o fa-lg"></i></a> 
