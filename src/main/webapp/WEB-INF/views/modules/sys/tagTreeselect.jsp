...
<head>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			$.get("${ctx}${url}${fn:indexOf(url,'?')==-1?'?':'&'}&extId=${extId}&isAll=${isAll}&type=${type}&maxType=${maxType}&minType=${minType}&module=${module}&isNotNeedSubPobc=${isNotNeedSubPobc}&clearCenterFilter=${clearCenterFilter}&t="
