...
<head>
	...
	<script type="text/javascript">
		...
		function changeAmountToBig(amount, toId) {
			...
			$.ajax({
				url : ctx + '/clear/v03/bankPayCtrl/changRMBAmountToBig?amount=' + amount,
				type : 'post',
				dataType : 'json',
		...
		/* function changeBankConnect(officeId){
			...
			$.ajax({
				...
				success : function(data) {
					...
					$("#meetingRoom").empty();
					$("#bankManNoA").append('<option value="">请选择</option>');
...
<body>
	<ul class="nav nav-tabs">
		...
		<!-- 商行交款登记 -->
		<li class="active"><a href="${ctx}/clear/v03/bankPayCtrl/form"><spring:message code="clear.bankPay.register" /></a></li>
	</ul>

	<form:form id="inputForm" modelAttribute="bankPayInfo" onkeydown="if(event.keyCode==13)return false;" action="${ctx}/clear/v03/bankPayCtrl/save" method="post" class="form-horizontal" >
...
<%-- 				<div class="control-group">
			...
			<!-- 面值明细 -->
			<div class="span7">
				<sys:denominationList dataSource="${bankPayInfo.denominationList}"  bindListName="denominationList" totalAmountId="inAmount"/>
			</div>
		</div>
		<div class="row">
