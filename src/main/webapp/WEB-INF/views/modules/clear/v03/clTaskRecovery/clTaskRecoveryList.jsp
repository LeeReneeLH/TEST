...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
         ...
         // 批量审批打印
			$("#btnPrint").click(function(){
				...
				var content = "iframe:${ctx}/clear/v03/clTaskRecovery/batchPrint?allIds=" + allIds;
				top.$.jBox.open(
						content,
						//打印
						"<spring:message code='common.print' />", 900, 600, {
							...
							submit : function(v, h, f) {
								...
								$("#searchForm").attr("action", "${ctx}/clear/v03/clTaskRecovery/list?pageType=" + $("#pageType").val());
								$("#searchForm").submit();
							},
							loaded : function(h) {
		...
		function printDetail(taskNo){
			var content = "iframe:${ctx}/clear/v03/clTaskRecovery/printClTaskRecoveryDetail?taskNo=" + taskNo;
			top.$.jBox.open(
					content,
					//打印
					"<spring:message code='common.print' />", 900, 600, {
...
<body>
	<ul class="nav nav-tabs">
		<!-- 任务回收列表 -->
		<li class="active"><a href="${ctx}/clear/v03/clTaskRecovery/"><spring:message code='clear.task.recovery.list'/></a></li>
		<!-- 任务回收登记 -->
		<shiro:hasPermission name="clear:v03:clTaskRecovery:edit"><li><a href="${ctx}/clear/v03/clTaskRecovery/form"><spring:message code='clear.task.recovery.register'/></a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="clTaskMain"
		action="${ctx}/clear/v03/clTaskRecovery/" method="post"
	...
	<shiro:hasAnyPermissions name="clear:clTaskRecovery:print">
	<!-- 批量打印 -->
	...
	<table id="contentTable" class="table table table-hover">
		<thead>
			<tr>
				<shiro:hasPermission name="clear:v03:clTaskMain:print">	
				<!-- 全打印 -->
				<th style="text-align:center;"><input type="checkbox" id="allPrintCheckbox" /></th>
				</shiro:hasPermission>
				<!-- 业务流水 -->
				...
				<!-- 清分交接人 -->
				<th><spring:message
						code='allocation.agentOfcommerceBank.handover' /></th>
				<!-- 任务类型 -->
				...
				<!-- end -->
				<!-- 操作 -->
				<shiro:hasPermission name="clear:v03:clTaskRecovery:edit">
					<th><spring:message code='common.operation' /></th>
				</shiro:hasPermission>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${page.list}" var="clTaskMain">
				<tr>
					<shiro:hasPermission name="clear:v03:clTaskRecovery:view">
						<shiro:hasPermission name="clear:v03:clTaskMain:print">
						<!-- 多选框 -->
						<td style="text-align: center"><input type="checkbox" id="chkPrintItem" value="${clTaskMain.taskNo}" /></td>
						</shiro:hasPermission>
						<!-- 业务流水 -->
						<td>
							<a href="${ctx}/clear/v03/clTaskRecovery/view?taskNo=${clTaskMain.taskNo}">${clTaskMain.taskNo}</a>
						</td>
						<!-- 业务类型 -->
						...
						<%-- <span style='width:30px;display:inline-block;'> 
							<shiro:hasAnyPermissions name="clear:v03:clTaskRecovery:view">
								<!-- 查看明细 -->
								<a href="${ctx}/clear/v03/clTaskRecovery/view?taskNo=${clTaskMain.taskNo}"
									title="<spring:message code='clear.task.checketails' />"> <i class="fa fa-eye fa-lg"></i>
								</a>
							</shiro:hasAnyPermissions>
						</span> --%>
