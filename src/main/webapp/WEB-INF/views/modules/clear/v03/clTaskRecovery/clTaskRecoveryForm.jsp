...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			checkSession();
			$("#clearGroupDiv").load("${ctx}/clear/v03/clTaskRecovery/getClearGroup?clearGroupId="+$('#clearGroup').val());
			...
			$("#btnSubmit").click(
				function() {
					...
					var url = "${ctx}/clear/v03/clTaskRecovery/save?userCount="+userCount;
		...
		function getClearGroup(type) {
			checkSession();
			$("#clearGroupDiv").load("${ctx}/clear/v03/clTaskRecovery/getClearGroup?clearGroupId="+ type);
		}
		...
		function formClear() {
			...
			checkSession();
			$("#clearGroupDiv").load("${ctx}/clear/v03/clTaskRecovery/getClearGroup?clearGroupId="+ clearGroupId);
			$("#totalcount").val("0");
		}
		// 计算总数量
...
<body>
	<ul class="nav nav-tabs">
		...
		<!-- 任务回收登记 -->
		<li class="active"><a href="${ctx}/clear/v03/clTaskRecovery/form"><spring:message code='clear.task.recovery.register'/></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="clTaskMain" action="" method="post" class="form-horizontal">
		<form:hidden path="id"/>
