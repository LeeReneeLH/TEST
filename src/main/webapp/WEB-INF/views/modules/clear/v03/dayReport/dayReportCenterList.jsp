		...
		<tbody>
			<c:forEach items="${dayReportMain.dayReportCenterList}" var="dayReportCenter" varStatus="status">
				<tr>
					...
					<td>
						<!-- 查看 -->
						<a href="${ctx}/clear/v03/dayReportCenter/detailView?accountsType=${dayReportCenter.accountsType}&reportDate=${dayReportCenter.reportDate}" title = "<spring:message code='common.view'/>">
