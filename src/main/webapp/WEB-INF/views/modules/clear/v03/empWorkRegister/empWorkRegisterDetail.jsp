...
<body>
	<ul class="nav nav-tabs">
		<!-- 员工工作量登记 -->
		<shiro:hasPermission name="clear:v03:empWorkRegister:edit"><li><a href="${ctx}/clear/v03/empWorkRegister/form"><spring:message code="clear.empWorkRegister.register" /></a></li>
		</shiro:hasPermission>
		<!-- 员工工作量登记列表 -->
		<li><a href="${ctx}/clear/v03/empWorkRegister/"><spring:message code="clear.empWorkRegister.list" /></a></li>
		<!-- 员工工作量登记查看 -->
		<li class="active"><a href="#" onclick="javascript:return false;"><spring:message code="clear.empWorkRegister.register.view"/></a></li>
	</ul><br/>
	<form:form id="detailForm" modelAttribute="clTaskMain" action=""
				...
				<div class="control-group item">
					...
					<div class="controls" style="margin-left: 185px;">
						<input type="text" id="taskType" name="taskType"
							value="<spring:message code="clear.empWorkRegister.register" />"
		...
		<div>
			...
			<input id="btnCancel" class="btn btn-default" type="button"
				...
				onclick="window.location.href='${ctx}/clear/v03/empWorkRegister/back'" />
			</div>
		</div>
	</form:form>
</body>
