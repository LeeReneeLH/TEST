...
<head>
	<!-- 任务分配查看 -->
	<title><spring:message code="clear.task.distribution.view"/></title>
...
<body>
	<ul class="nav nav-tabs">
		...
		<!-- 任务分配查看 -->
		<li class="active"><a href="#" onclick="javascript:return false;"><spring:message code="clear.task.distribution.view"/></a></li>
	</ul><br/>
	<form:form id="detailForm" modelAttribute="clTaskMain" action=""
		...
		<div class="row">
			    	<div class="span20" style="text-align: right">
			    		<!-- 任务明细 -->
			    		<h4 style="border-top:1px solid #eee;color:#dc776a;text-align:center"><spring:message
										code="clear.task.detail" /></h4>
					...
					<table id="contentTable" class="table table-hover">
						...
						<tbody>
							<c:forEach items="${clTaskMain.clTaskDetailList}"
								var="clDetail" varStatus="status">
								<!-- 任务详细 -->
								<tr>
									<td width="10%" style="text-align: center">${status.index+1}</td>
									<td style="text-align: center;"><%-- ${fns:getDictLabel(clDetail.officeNo, 'sys_user_type', '')} --%>
									${fns:getDictLabel(clDetail.workingPositionType,'clear_working_position_type',"")}</td>
