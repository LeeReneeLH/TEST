...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function() {
         ...
         // 批量审批打印
			$("#btnPrint").click(function(){
				...
				var content = "iframe:${ctx}/clear/v03/clTaskMain/batchPrint?allIds=" + allIds;
				top.$.jBox.open(
						content,
						//打印
						"<spring:message code='common.print' />", 900, 600, {
							...
							submit : function(v, h, f) {
								...
								$("#searchForm").attr("action", "${ctx}/clear/v03/clTaskMain/list?pageType=" + $("#pageType").val());
								$("#searchForm").submit();
							},
							loaded : function(h) {
		...
		function printDetail(taskNo){
			var content = "iframe:${ctx}/clear/v03/clTaskMain/printclTaskMainDetail?taskNo=" + taskNo;
			top.$.jBox.open(
					content,
					//打印
					"<spring:message code='common.print' />", 900, 600, {
...
<body>
	<ul class="nav nav-tabs">
		<!-- 任务分配列表 -->
		<li class="active"><a href="${ctx}/clear/v03/clTaskMain/"><spring:message code='clear.task.distribution.list'/></a></li>
		<!-- 任务分配登记 -->
		<shiro:hasPermission name="clear:v03:clTaskMain:edit"><li><a href="${ctx}/clear/v03/clTaskMain/form"><spring:message code='clear.task.distribution.register'/></a></li></shiro:hasPermission>
	</ul>
	<form:form id="searchForm" modelAttribute="clTaskMain"
		action="${ctx}/clear/v03/clTaskMain/" method="post"
	...
	<table id="contentTable" class="table table table-hover">
		<thead>
			...
			<shiro:hasPermission name="clear:v03:clTaskMain:print">	
				...
				<!-- end -->
				<shiro:hasPermission name="clear:v03:clTaskMain:edit">
					<!-- 操作 -->
		...
		<c:forEach items="${page.list}" var="clTaskMain">
				<tr>
					<shiro:hasPermission name="clear:v03:clTaskMain:view">
					<shiro:hasPermission name="clear:v03:clTaskMain:print">	
						<!-- 多选框 -->
						...
						<!-- 业务流水 -->
						<td>
							<a href="${ctx}/clear/v03/clTaskMain/view?taskNo=${clTaskMain.taskNo}">${clTaskMain.taskNo}</a>
						</td>
						<!-- 业务类型 -->
						...
						<td>
							<%-- <span style='width:30px;display:inline-block;'> 
								<!-- 查看明细 -->
								<a href="${ctx}/clear/v03/clTaskMain/view?taskNo=${clTaskMain.taskNo}"
									title="<spring:message code='clear.task.checketails' />"><i class="fa fa-eye fa-lg"></i></a> 
							</span> --%>
							
							<span style='width:20px;display:inline-block;'>
								<!-- 打印 -->
								<a href="#"onclick="printDetail('${clTaskMain.taskNo}');" title="<spring:message code='common.print'/>"><i
									class="fa fa-print text-yellow fa-lg"></i></a>
							</span>
