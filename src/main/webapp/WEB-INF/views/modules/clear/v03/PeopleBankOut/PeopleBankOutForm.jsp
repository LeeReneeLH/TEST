...
<head>
	<%-- 从人行复点出库登记 --%>
	<title><spring:message code='clear.peopleBankOut.register'/> </title>
...
<body>
	<ul class="nav nav-tabs">
		...
		<!-- 从人行复点出库登记 -->
		<li class="active"><a href="${ctx}/clear/v03/peopleBankOut/form"><spring:message code='clear.peopleBankOut.register'/></a></li>
	</ul>

	<form:form id="inputForm" modelAttribute="bankPayInfo" onkeydown="if(event.keyCode==13)return false;" action="${ctx}/clear/v03/peopleBankOut/save" method="post" class="form-horizontal" >
		...
		<div class="row">
			...
			<!-- 面值明细 -->
			<div class="span6">
				<sys:peopleBankOutList dataSource="${bankPayInfo.denominationList}"  bindListName="denominationList" totalAmountId="inAmount"/>
			</div>
		</div>
		<div class="row">
