...
<body>
	<ul class="nav nav-tabs">
		<!-- 备付金取回列表 -->
		<li><a href="${ctx}/clear/v03/provisionsOut/"><spring:message code="clear.provisionOut.list" /></a></li>
		<%-- 备付金取回查看 --%>
		<li class="active"><a href="#" onclick="javascript:return false;"><spring:message code="clear.provisionOut.view" /></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="clOutMain" action="${ctx}/clear/v03/provisionsOut/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<div class="row">
			...
			<div class="span7">
				...
				<div class="control-group">
					...
					<div class="controls">
					<input id="outAmount" name="outAmount"  type="text" value="<fmt:formatNumber value="${clOutMain.outAmount}" pattern="#,##0.00#"/>"  disabled/>
					<span class="help-inline"><font color="red">*</font> </span>
					</div>
				</div>
			...
			<!-- 面值明细 -->
			<div class="span6">
				<sys:provisionsIn dataSource="${clOutMain.denominationList}"  bindListName="denominationList" totalAmountId="outAmount" allowInput="false"/>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="form-actions" style="width:100%;">
				...
				onclick="window.location.href='${ctx}/clear/v03/provisionsOut/list'" />
			</div>
