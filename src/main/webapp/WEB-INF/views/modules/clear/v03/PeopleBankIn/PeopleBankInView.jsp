...
<head>
	<!-- 从人行复点入库查看 -->
	<title><spring:message code="clear.peopleBankIn.view" /></title>
...
<body>
	<ul class="nav nav-tabs">
		...
		<!-- 从人行复点入库查看 -->
		<li class="active"><a href="#" onclick="javascript:return false;"><spring:message code="clear.peopleBankIn.view" /></a></li>
	</ul>
		...
		<div class="row">
			...
			<div class="span7" >
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea id="inAmountBigRmb" name="inAmountBigRmb" disabled>${sto:getUpperAmount(clOutMain.outAmount)}</textarea>
					</div>
				</div>
			...
			<!-- 修改自定义标签 wzj 2017-11-17 begin -->
				<sys:peopleBankInList dataSource="${clOutMain.denominationList}"  bindListName="denominationList" totalAmountId="outAmount" allowInput="false"/>
			<!-- end -->
			</div>
