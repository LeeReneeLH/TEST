	...
	<div id="printDiv" >
		<table
			...
			<tr>
				...
				<td style="text-align: left; width: 300px; border: 1px solid;">${clOutMain.rOffice.name}</td>
				<td style="text-align: center; width: 90px; border: 1px solid;">
				<!-- 交款单位 -->
			...
			<tr>
				...
				<!-- 支出 -->
				<td style="text-align: left; width: 300px; border: 1px solid;"><spring:message code="clear.public.outCome" /></td>
				<td style="text-align: center; width: 90px; border: 1px solid;">
				<!-- 总金额 -->
			...
			<tr>
				<td style="text-align: left; width: 365px; border: 1px solid; word-wrap:break-word;word-break:break-all;"
					...
					<!-- 备注 -->
					<font size="2"><b><spring:message code="common.remark" />:</b></font><br><font size="2">${clOutMain.remarks}</font></td>
				<td style="text-align: center; width: 90px; border: 1px solid;">
				<!--总金额大写  -->
		...
		<table style="width:100%; float: left; margin-left: 20px;">
			<tr>
				...
				<td style="width: 180px;">${clOutMain.createName}</td>
				<!-- 收款 -->
				<td style="width: 55px;"><b><spring:message code="clear.public.receipt" />：</b></td>
				<td style="width: 150px;">${clOutMain.transManName}</td>
				<!-- 复核 -->
				<td style="width: 55px;"><b><spring:message code="common.voucherVerifying" />：</b></td>
				<td style="width: 150px;">${clOutMain.checkManName}</td>
				<!-- 交款 -->
				<td style="width: 55px;"><b><spring:message code="clear.public.payment" />：</b></td>
				<td style="width: 150px;">${clOutMain.bankManNameA},${clOutMain.bankManNameB}</td>
			</tr>
		</table>
	</div>
</body>
