...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="#" onclick="javascript:return false;">商户查看</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="storeOffice" action="${ctx}/collection/v03/storeOffice/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="name" htmlEscape="false" maxlength="20" value="${fns:getDictLabel(storeOffice.enabledFlag, 'enabled_type', '')} " class="required" readOnly="readOnly"/>
				<span class="help-inline"><font color="red">*</font> </span>
			</div>
		</div>
