...
<body>
	<ul class="nav nav-tabs">
		<!-- 款箱拆箱列表 -->
		<li class="active"><a onClick="window.top.clickSelect();" href="${ctx}/collection/v03/checkCash/"><spring:message code="door.checkCash.title" /><spring:message code="common.list" /></a></li>
		<!-- 款箱拆箱添加 -->
		...
		<!-- 拆箱历史记录 -->
		<li><a href="${ctx}/collection/v03/checkCash/historyList" onClick="window.top.clickSelect();"><spring:message code="clear.atmCashBox.history" /></a></li>
	</ul>
	<form:form id="inputForm" onClick="window.top.clickSelect();" modelAttribute="checkCashMain" action="" method="post" class="form-horizontal"></form:form>
	...
	<!-- <div class="row"> -->
	<form:form id="searchForm" modelAttribute="checkCashMain" action="${ctx}/collection/v03/checkCash/list?uninitDateFlag=0" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-hover">
		<thead>
			<tr>
				...
				<%-- 清分人员 --%>
				<th class="sort-column create_name"><spring:message
						code="door.checkCash.clearMan" /></th>
				<%-- 登记时间 --%>
				<th class="sort-column reg_date"><spring:message
					...
					<td>
						<shiro:hasPermission name="check:checkCash:edit">
							<c:if test="${checkCashMain.noBoxCount !=0}">
								...
								<!-- 快速拆箱 gzd 2020-05-07 -->
								<span style='width: 25px; display: inline-block;'>
									<a id="cx" href="#" title="快速确认" onclick="cx('${checkCashMain.outNo}','${checkCashMain.trueSumMoney}');return false;">
										<i style="color:#FF9800;" class="fa fa-check fa-lg"></i>
									</a>
								</span>
							</c:if>
							<c:if test="${checkCashMain.noBoxCount ==0}">
								<span style='width: 25px; display: inline-block;'> <%-- 冲正 --%>
									<a id="aReverse" href="#"
									onclick="authorize('${checkCashMain.outNo}')"
