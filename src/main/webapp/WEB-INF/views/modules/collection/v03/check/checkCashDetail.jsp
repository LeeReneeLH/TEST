...
<html>
<head>
    <title><spring:message code="door.checkCash.detail" /></title>
    ...
    $(document).ready(function() {
		$("#exportSubmit").on('click',function(){
			$("#searchForm").prop("action", "${ctx}/collection/v03/checkCash/exportDetail");
			$("#searchForm").submit();
			$("#searchForm").prop("action", "${ctx}/collection/v03/checkCash/checkCashDetail");		
		});
	});
        function page(n,s){
            $("#pageNo").val(n);
...
<ul class="nav nav-tabs">
    ...
    <!-- 历史拆箱列表 -->
	<li><a onClick="window.top.clickSelect();" href="${ctx}/collection/v03/checkCash/historyList"><spring:message code="clear.atmCashBox.history" /></a></li>
	<!-- 存款明细列表 -->
    <li class="active"><a><spring:message code="door.historyUseRecords.detail" /><spring:message code="common.list" /></a></li>
</ul>
<form:form id="searchForm" modelAttribute="historyUseRecordsDetail" action="${ctx}/collection/v03/checkCash/checkCashDetail" method="post" class="breadcrumb form-search ">
