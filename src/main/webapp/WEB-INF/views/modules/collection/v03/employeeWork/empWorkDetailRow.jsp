...
<div class="row" style="margin-left:2px;margin-top:20px;">
	<table id="contentTable" class="table table table-hover">
		<thead>
			<tr>
				<!-- 面额 -->
				<th style="text-align: center;"><spring:message code="door.empWork.denomination" /></th>
				<!-- 数量（张） -->
				<th style="text-align: center;"><spring:message code="door.empWork.sheetCount" /></th>
				<!-- 金额（元） -->
				<th style="text-align: center;"><spring:message code="door.empWork.moneyYuan" /></th>
			</tr>
		</thead>
		<tbody>
