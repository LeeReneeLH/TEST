...
<body>
	<ul class="nav nav-tabs">
		<%-- 库间清分列表 --%>
		<li><a
			href="${ctx}/allocation/v01/cashBetweenClear/list?businessType=${allAllocateInfo.businessType}"><spring:message code="allocation.cashBetween.clear.list" /></a></li>
		<shiro:hasPermission name="allocation:cashStoreClear:edit">
			<%-- 清分出库登记 --%>
			<li><a
				href="${ctx}/allocation/v01/cashBetweenClear/toCashOutStoreForm?businessType=${allAllocateInfo.businessType}"><spring:message code="allocation.clear.outStore.register" /></a></li>
		</shiro:hasPermission>
		<%-- 明细查看 --%>
	...
	<div class="row" style="margin-left: 10px">
		<div class="span8">
			...
			<div class="row">
				...
				<div class="span8">
					<form:form id="tempform" class="form-horizontal">
						...
						<div class="control-group item">
							<%-- 登记机构 --%>
							<label class="control-label" style="width: 100px;"><spring:message code="allocation.register.office" />：</label>
							<div class="controls" style="margin-left: 110px;">
								<input id="rofficeName" name="rofficeName" type="text"
									readOnly="readOnly" style="width: 170px;"
						...
						<div class="control-group item">
							<%-- 出库日期 --%>
							<label class="control-label" style="width: 100px;"><spring:message code="common.outDate" />：</label>
							<div class="controls" style="margin-left: 110px;">
						...
						<div class="control-group item">
							<%-- 接收日期 --%>
							<label class="control-label" style="width: 100px;"><spring:message code="clear.clearConfirm.receiveDate" />：</label>
							<div class="controls" style="margin-left: 110px;">
			...
			<div class="row" style="padding-left: 30px">
				<div class="span8" style="text-align: left">
					<%-- 登记金额 --%>
					<label><spring:message code="allocation.register.amount" />：</label> <input type="text" id="registerAmountShow"
						value="<fmt:formatNumber value="${allAllocateInfo.registerAmount}" 
						pattern="#,##0.00#" />"
			...
			<div class="row">
				<div class="span8">
					...
					<!-- <h4 style="color:#34b15b;text-align:center;border-top:1px solid #eee"><spring:message code="allocation.outStore.detail" /></h4> -->
						<table id="contentTable"
							class="table table-hover" style="border-top:1px solid #eee;">
							<thead>
								<%-- <tr>
									出库明细
							...
							<tbody>
								<%
									int iRegistIndex = 0;
								%>
								<c:forEach items="${allAllocateInfo.allAllocateItemList}"
		...
		<div class="span8">
			<div class="row">
				<div class="span8">
					<h4 style="color:#34b15b;text-align:center;border-bottom:1px solid #eee;margin-bottom:10px;">
						<%-- 入库明细 --%>
				...
				<div class="span8">
					<form:form id="tempform" class="form-horizontal">
						...
						<div class="control-group item">
							...
							<div class="controls" style="margin-left: 90px;">
								<input id="aofficeName" name="aofficeName" type="text"
									readOnly="readOnly" style="width: 170px;"
						...
						<div class="control-group item">
							...
							<div class="controls" style="margin-left: 90px;">
								<input id="clearName" name="clearName" type="text"
									readOnly="readOnly" style="width: 170px;"
						...
						<div class="control-group item">
							<%-- 清分日期 --%>
							<label class="control-label" style="width: 100px;"><spring:message code="allocation.clearDate" />：</label>
							<div class="controls" style="margin-left: 110px;">
								<input id="clearDate" name="clearDate" type="text"
									readOnly="readOnly" style="width: 170px;"
			...
			<div class="row" style="padding-left: 30px">
				<div class="span8" style="text-align: left">
					<%-- 接收金额 --%>
					<label><spring:message code="allocation.confirm.amount" />： </label> <input type="text" id="confirmAmountShow"
						value="<fmt:formatNumber value="${allAllocateInfo.confirmAmount}"
						 pattern="#,##0.00#" />"
						class="input-medium" style="text-align: right; width: 170px;"
						readOnly="readOnly" />
					<%-- 接收金额(格式化) --%>
					<label style="margin-left: 10px;">${sto:getUpperAmount(allAllocateInfo.confirmAmount)}</label>
				</div>
			</div>
			<div class="row">
				<div class="span8">
