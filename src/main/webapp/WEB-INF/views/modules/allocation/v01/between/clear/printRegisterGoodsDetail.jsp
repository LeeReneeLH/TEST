...
<head>
	<%-- 库间清分配款清单 --%>
	<title><spring:message code="allocation.cashBetween.clear.quota.list" /></title>
...
<body>
	<div id="printDiv">
		<div style="text-align: center;margin-top: 20px;">
			<%-- 库间清分配款清单 --%>
			<label style="text-align: center"><font size="4"><b><spring:message code="allocation.cashBetween.clear.quota.list" /></b></font></label>
		</div>
		...
		<div style="width: 100%">
			<%-- 登记机构 --%>
			<label style="text-align: left;"><spring:message code="allocation.register.office" />：${allAllocateInfo.rOffice.name}</label>
		</div>
		<div style="width: 100%">
			<%-- 清分机构 --%>
			<label style="text-align: left;"><spring:message code="common.agent.office" />：${allAllocateInfo.aOffice.name}</label>
		</div>
		<div style="width: 100%">
			<%-- 登记日期 --%>
			<label style="text-align: left;"><spring:message code="clear.orderClear.registerDate" />：<fmt:formatDate value="${allAllocateInfo.createDate}" pattern="yyyy-MM-dd HH:mm:ss"/></label>
		</div>
		<div style="width: 100%">
			<%-- 登记金额 --%>
