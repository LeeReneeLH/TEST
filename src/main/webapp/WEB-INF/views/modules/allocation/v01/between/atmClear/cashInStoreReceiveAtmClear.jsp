	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#btnSubmit").click(function(){
				$("#commitForm").attr("action","${ctx}/allocation/v01/cashBetweenAtmClear/saveCashReceiveInfo?allId=" + $("#allId").val());
				$("#commitForm").submit();
			});
		});
	</script>
					...
					<form:form id="inputForm" class="form-horizontal">
						<div class="control-group item">
							...
							<div class="controls" style="margin-left: 90px;">
						   		<input id="aofficeName"  name="aofficeName" type="text" readOnly="readOnly"  style="width:149px;"
						...
						<div class="control-group item">
							...
							<div class="controls" style="margin-left: 90px;">
						   		<input id="clearName"  name="clearName" type="text" readOnly="readOnly"  style="width:149px;"
							   	value="${allAllocateInfo.clearInRegisterName}"/>
							</div>
						</div>
						<div class="control-group item">
							<%-- 登记日期 --%>
							<label class="control-label" style="width:80px;"><spring:message code="clear.atmCashBox.registerDate" />：</label>
							<div class="controls" style="margin-left: 90px;">
						   		<input id="clearDate"  name="clearDate" type="text" readOnly="readOnly"  style="width:149px;"
								...
								<c:forEach items="${allAllocateInfo.allAllocateItemList}" var="item" varStatus="status">
										<c:if test="${item.confirmFlag == '0'}">
											...
											<tr id="${item.goodsId}">
												...
												<td style="text-align:right;">${item.boxNo}</td>
												<td style="text-align:right;">${item.batchNo}</td>
											</tr>
										</c:if>
								</c:forEach>
							</tbody>
