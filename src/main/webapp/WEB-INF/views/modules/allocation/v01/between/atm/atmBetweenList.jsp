...
<html>
<head>
	<title><spring:message code='allocation.atm.box.between'/></title>
...
<body>
	...
	<form:form id="searchForm" modelAttribute="allAllocateInfo" action="${ctx}/allocation/v01/atmBetween/list?searchFlag=true" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-hover">
		<thead>
			<tr>
				...
				<%-- 登记数量 --%>
				<th><spring:message code='allocation.register.number'/></th>
				<%-- 移交人 --%>
		...
		<c:forEach items="${page.list}" var="atmInfo">
			<tr>
				...
				<td><a href="${ctx}/allocation/v01/atmBetween/form?allId=${atmInfo.allId}">${atmInfo.allId}</a></td>
			</tr>
		</c:forEach>
		</tbody>
	</table>
