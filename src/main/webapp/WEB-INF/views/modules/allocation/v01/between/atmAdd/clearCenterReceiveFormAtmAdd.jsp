	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			$("#btnSubmit").click(function(){
				$("#inputForm").attr("action", "${ctx}/allocation/v01/cashBetweenAtmAdd/saveConfirmInfo?strUpdateDate="+ $("#strUpdateDate").val());
				$("#inputForm").submit();
				return;
			});
		});
...
<body>
	...
	<form:form id="inputForm" modelAttribute="allAllocateInfo" action="" method="post" class="form-horizontal">
		...
		<div class="control-group" style="margin-top: 10px;">
			<label class="control-label" style="width:80px;"><spring:message code="common.serial.orderNo" />：</label>
		...
		<div class="control-group" style="margin-top: 10px;">
	     ...
	     <%-- 登记时间 --%>
		<div class="control-group" style="margin-top: 10px;">
			<label class="control-label" style="width:80px;"><spring:message code="common.registerTime" />：</label>
			<div class="controls" style="margin-left:90px;">
