...
<body>
	<div id="printDiv">
		<div style="text-align: center;margin-top: 20px;">
			<%-- 上缴审批信息清单 --%>
			<label style="text-align: center"><font size="4"><b><spring:message code="allocation.handin.approve.infoList" /></b></font></label>
		</div>
		...
		<table id="contentTable" style="width: 100%; border: 1px solid black; text-align: left;border-collapse:collapse;" border="1">
			<thead>
				<tr>
					<%-- 申请机构 --%>
					...
					<%-- 流通券金额 --%>
					<th style="text-align: center"><spring:message code="common.circulationNote.amount" /></th>
					<%-- 残损券金额 --%>
					<th style="text-align: center"><spring:message code="common.damagedNote.amount" /></th>
					<%-- 合计金额 --%>
			...
			<tfoot>
				<tr>
					...
					<%-- 残损券合计金额 --%>
					<td style="text-align:right;"><fmt:formatNumber value="${damagedCouponAllAmount}" pattern="#,##0.00#" /></td>
					<%-- 合计金额 --%>
			...
			<tbody>
				<c:forEach items="${printDataList}"	var="approvalPrintDetail" varStatus="status">
						<tr>
							...
							<%-- 残损券金额 --%>
							<td style="text-align:right;"><fmt:formatNumber value="${approvalPrintDetail.damagedCouponAmount}" pattern="#,##0.00#" /></td>
							<%-- 合计金额 --%>
