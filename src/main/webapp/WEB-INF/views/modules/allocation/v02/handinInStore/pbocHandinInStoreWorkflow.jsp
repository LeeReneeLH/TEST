...
<style type="text/css">
.work_flow_01_done,.work_flow_02_done,.work_flow_05_done,.work_flow_07_done,.handin-03,#workflow-return-btn-01:HOVER {
	cursor: pointer;
}
</style>
...
<body>
	...
	<div style="float:left;">
		...
		<div class="workflow-con">
			...
			<a href="#"><spring:message code="allocation.cash.handin.register" /></a>
		</div>
		<!-- 流程 01 end-->
		<c:choose>
			<c:when test="${picInfo.toApproval.colorFlag}">
		...
		<div class="workflow-con">
			...
			<c:choose>
				<c:when test="${picInfo.toInOutStore.colorFlag||picInfo.reject.colorFlag}">
		...
		<!-- 流程 02 end-->
		<c:choose>
			<c:when test="${picInfo.toInOutStore.colorFlag and !picInfo.reject.colorFlag}">
				<div class="workflow-line-green"></div>
			</c:when>
			<c:otherwise>
				<div class="workflow-line"></div>
