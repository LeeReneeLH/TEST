...
<body>
	<div id="printDiv">
		<div style="text-align: center;margin-top: 15px;">
			<%-- 发行基金出库 --%>
			<label style="text-align: center"><font size="4"><b><spring:message code="allocation.issueFund.outStore" /></b></font></label>
		</div>
		...
		<table id="contentTable"
			...
			<thead>
				<tr>
					...
					<%-- 取包明细 --%>
					<th style="text-align: center" colspan="4"><spring:message code="allocation.getBagDetail" /></th>
				</tr>
				<tr>
