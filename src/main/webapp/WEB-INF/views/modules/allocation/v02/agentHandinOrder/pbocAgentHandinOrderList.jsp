				...
				<tr>
					...
					<td>
						<c:if test="${allocation.status == '20'}">
							<a href="${ctx}/allocation/v02/pbocAgentHandinOrder/form?allId=${allocation.allId}&pageType=bussnessApplicationEdit" title="编辑">
						...
						<c:choose>
							<c:when test="${allocation.status == '20'}">
								<a href="${ctx}/allocation/v02/pbocAgentHandinOrder/form?allId=${allocation.allId}&pageType=bussnessApplicationEdit" title="编辑"><i class="fa fa-eye fa-lg"></i></a>
							</c:when>
							<c:otherwise>
								<a href="${ctx}/allocation/v02/pbocAgentHandinOrder/form?allId=${allocation.allId}&pageType=bussnessApplicationView" title="查看"><i class="fa fa-eye fa-lg"></i></a>
							</c:otherwise>
						</c:choose>
					</td>
				</tr>
