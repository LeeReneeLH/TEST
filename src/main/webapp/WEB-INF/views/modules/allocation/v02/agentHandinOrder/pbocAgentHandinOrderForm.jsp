	...
	<script type="text/javascript">
		$(document).ready(function() {
            ...
            $("#add").click(function () {
            	//清除tr背景色
            	clearTrBackgroundColor();
            	var url = "${ctx}/allocation/v02/pbocAgentHandinOrder/add?userCacheId=" + $("#cacheId").val();
			...
			$("#btnSubmit").click(function(){
				...
				$("#inputForm").attr("action","${ctx}/allocation/v02/pbocAgentHandinOrder/save?pageType=bussnessApplicationList&strUpdateDate=" 
		...
		function updateItem(goodsId, goodsName, number) {	
			//清除tr背景色
			clearTrBackgroundColor();
			var url = "${ctx}/allocation/v02/pbocAgentHandinOrder/updateGoodsItem?userCacheId=" + $("#cacheId").val();
						...
						<c:forEach items="${fns:getCache(userCacheId, null).pbocAllAllocateItemList}" var="item" varStatus="status">
							<tr id="${item.goodsId}">
								...
								<td style="text-align:center;">
									<a href="${ctx}/allocation/v02/pbocAgentHandinOrder/deleteGoods?goodsId=${item.goodsId}&userCacheId=${userCacheId }"
		...
		<div class="span9">
			<div class="form-actions">
				...
				<input id="btnCancel" class="btn" type="button"
					...
					onclick="window.location.href='${ctx}/allocation/v02/pbocAgentHandinOrder/back?pageType=bussnessApplicationList&userCacheId=${userCacheId }'"/>
			</div>
