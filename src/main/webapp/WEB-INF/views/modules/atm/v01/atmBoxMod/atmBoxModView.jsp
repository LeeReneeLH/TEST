...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/atm/v01/atmBoxMod/"><spring:message code="atm.modelConfigure.list"/></a></li>
	   	<li class="active"><a href="${ctx}/atm/v01/atmBoxMod/view?id=${atmBoxMod.id}">
				<spring:message code="atm.modelConfigure" /><spring:message code="common.view" />
		</a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="atmBoxMod" action="${ctx}/atm/v01/atmBoxMod/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="modName" htmlEscape="false" maxlength="10" class="input-large required" readonly="true" style="font-size:16px"/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<select id="boxTypeNos" name="boxTypeNos" class="input-large required" required="required" style="font-size:16px;">
					<option value="">
						<spring:message code="common.select" />
					</option>
				</select>
