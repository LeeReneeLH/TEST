...
<link href="${ctxStatic}/bootstrap/2.3.1/css_default/font-awesome.min.css" type="text/css" rel="stylesheet" /> 
...
<%-- <script src="${ctxStatic}/jquery-plugin/jquery.chained.js" type="text/javascript"></script> --%>
<link href="${ctxStatic}/jquery-validation/1.13.1/jquery.validate.min.css" type="text/css" rel="stylesheet" />
...
<link href="${ctxStatic}/common/AdminLTE.min.css" type="text/css" rel="stylesheet" />
<link href="${ctxStatic}/common/them.css" type="text/css" rel="stylesheet" />
<link href="${ctxStatic}/images/logo48.ico" rel="shortcut icon" type="image/x-icon" />
<link href="${ctxStatic}/common/table-them.css" type="text/css" rel="stylesheet" /> 
<script src="${ctxStatic}/common/boxtable-them.js" type="text/javascript"></script>
 <!--[if lt IE 9]> 
