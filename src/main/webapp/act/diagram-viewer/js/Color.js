...
var Color = {
  ...
  // http://www.stm.dp.ua/web-design/color-html.php
	...
	CustomExtTaskFinished		:   Raphael.getRGB("#f2f8e3	"),
	CustomExtTaskBoderFinished		:   Raphael.getRGB("#80c269	"),
	CustomExtTaskWorking		:   Raphael.getRGB("#fcefef	"),
	CustomExtTaskBoderWorking		:   Raphael.getRGB("#efa8a4	"),
	CustomExtTaskUndo		:   Raphael.getRGB("#f2f2f2	"),
	CustomExtTaskBoderUndo		:   Raphael.getRGB("#ececec	"),
	CustomExtFlowUndo		:   Raphael.getRGB("#bfbfbf	"),
	CustomExtFlowFinished		:   Raphael.getRGB("#80c269	"),
	CustomStartEventColor		:   Raphael.getRGB("#f2f8e3	"),
	CustomStartEventBoder		:   Raphael.getRGB("#80c269	"),
