 ...
 * @version 2017-02-13
 */
public class TaskDown extends DataEntity<TaskDown> {
	...
	public String getExtendeDay() {
		return extendeDay;
	}

	public void setExtendeDay(String extendeDay) {
		this.extendeDay = extendeDay;
	}
