 ...
 * @version 2017-09-04
 */
public class EmpWorkDetail extends DataEntity<EmpWorkDetail> {

	private static final long serialVersionUID = 1L;
	
	@ExcelField(title = "清分日期", align = 1)
	private String clearDate; 			// 清分日期
	private String clearManId; 			// 清分人员ID
	@ExcelField(title = "清分人员", align = 1)
	private String empName; 			// 清分人员
	...
	public EmpWorkDetail(String id) {
		super(id);
	}
