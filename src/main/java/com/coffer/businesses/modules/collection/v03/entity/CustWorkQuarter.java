 ...
 * @version 2017-09-04
 */
public class CustWorkQuarter extends DataEntity<CustWorkQuarter> {

	private static final long serialVersionUID = 1L;
	
	@ExcelField(title = "清分日期", align = 1)
	private String clearDate; 			// 清分日期
	private String clearDateId; 		// 清分日期
	...
	//检索部
	private String searchQuarter;		// 季度
	...
	public CustWorkQuarter() {
		super();
	}

	public CustWorkQuarter(String id) {
		super(id);
	}
	...
	public String getClearDateId() {
		return clearDateId;
	}

	public void setClearDateId(String clearDateId) {
		this.clearDateId = clearDateId;
	}
