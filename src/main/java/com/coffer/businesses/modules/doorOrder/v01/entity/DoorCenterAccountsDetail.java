 ...
 * @version 2017-09-04
 */
public class DoorCenterAccountsDetail extends DataEntity<DoorCenterAccountsDetail> {
	...
	/* end */
	public DoorCenterAccountsDetail() {
		super();
	}

	public DoorCenterAccountsDetail(String id){
		super(id);
	}
