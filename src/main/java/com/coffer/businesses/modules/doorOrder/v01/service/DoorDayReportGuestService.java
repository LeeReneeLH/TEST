...
public class DoorDayReportGuestService extends CrudService<DoorDayReportGuestDao, DoorDayReportGuest> {
	 ...
	 */
	@Transactional(readOnly = false)
	public synchronized void dayAccountReportByGuest(String windupType, DoorDayReportMain dayReportMain,
			Office office) {
		// 上门收款业务日结
		dayDoorOrderAccountReport(new DoorCenterAccountsMain(), windupType, dayReportMain, office);
	}
	 ...
	 * @return
	 */
	public List<DoorDayReportGuest> findAccountByAccountsType() {
		DoorDayReportGuest dayReportGuest = new DoorDayReportGuest();
