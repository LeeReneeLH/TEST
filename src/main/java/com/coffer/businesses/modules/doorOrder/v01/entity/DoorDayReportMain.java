 ...
 * @version 2017-09-08
 */
public class DoorDayReportMain extends DataEntity<DoorDayReportMain> {
	...
	/** 中心账务日结列表 */
	private List<DoorDayReportCenter> dayReportCenterList;

	/** 客户账务日结列表 */
	private List<DoorDayReportGuest> dayReportGuestList;
	...
	public DoorDayReportMain() {
		super();
	}

	public DoorDayReportMain(String id) {
		super(id);
	}
	...
	public List<DoorDayReportCenter> getDayReportCenterList() {
		return dayReportCenterList;
	}

	public void setDayReportCenterList(List<DoorDayReportCenter> dayReportCenterList) {
		this.dayReportCenterList = dayReportCenterList;
	}

	public List<DoorDayReportGuest> getDayReportGuestList() {
		return dayReportGuestList;
	}

	public void setDayReportGuestList(List<DoorDayReportGuest> dayReportGuestList) {
