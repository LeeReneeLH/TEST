 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/cloudPlateform/v04/visitorStatistics")
public class VisitorStatisticsController extends BaseController {
	 ...
	 * @return
	 */
	@RequiresPermissions("cloudPlateform:eyeCheckVisitorInfo:view")
	@RequestMapping(value = { "list", "" })
	public String list(EyeCheckVisitorInfo eyeCheckVisitorInfo, HttpServletRequest request,
			HttpServletResponse response, Model model) {
		eyeCheckVisitorInfo.setEscortType(CloudPlatformConstant.escortType.VISITOR);
		// 查询访客信息列表
		...
		model.addAttribute("vistor", "访客统计列表");
