 ...
 */
@Controller
@RequestMapping(value = "${adminPath}/report/v01/orderClearVolume")
public class OrderClearVolumeController extends BaseController {

	@Autowired
	private ClearReportService clearReportService;
	
	/**
	 * 根据查询条件，查询预约清分业务量一览信息
	 * 
	 * @author wxz
	 * @version 2017-11-30
	...
	public String toGraphPage(OrderClearMain orderClearMain, Model model) {
		...
		return "modules/clear/v03/orderClearVolume/orderClearVolume";
	}

	/**
	 * 
	 * Title: reserveClearVolume
	 * <p>Description: 预约清分业务量统计图</p>
	 * @author:     wxz
	 * @return 
	 * String    返回类型
	 */
	...
	@ResponseBody
	public String reserveClearVolume(OrderClearMain orderClear, HttpServletRequest request,
