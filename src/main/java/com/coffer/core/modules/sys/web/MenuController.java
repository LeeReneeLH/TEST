...
//		}
	...
	@ResponseBody
	@RequestMapping(value = "checkMenuId")
	public String checkMenuId(String id, String oldId) {
		if (id != null & id.equals(oldId)) {
			return "true";
		} else if (id != null && systemService.getMenu(
				id.split(Constant.Punctuation.COMMA)[id.split(Constant.Punctuation.COMMA).length - 1]) == null) {
			return "true";
		}
		return "false";
	}
