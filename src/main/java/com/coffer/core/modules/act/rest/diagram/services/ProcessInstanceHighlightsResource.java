...
package com.coffer.core.modules.act.rest.diagram.services;
  ...
  @Autowired
	...
	public ObjectNode getHighlighted(@PathVariable String processInstanceId) {
	  ...
	  ObjectNode responseJSON = objectMapper.createObjectNode();
		...
		ArrayNode finishedActivitiesArray = objectMapper.createArrayNode();
		...
		try {
			...
			List<String> finishedActivities = getFinishedActivitiesArray(processInstanceId);
			
			for (String activityId : finishedActivities) {
				finishedActivitiesArray.add(activityId);
			}
		...
		responseJSON.put("finishedActivities", finishedActivitiesArray);
	...
	/**
	 * 
	 * Title: getFinishedActivitiesArray
	 * <p>Description: 查询完成的任务</p>
	 * @author:     wangbaozhong
	 * @param processInstanceId
	 * @return 
	 * List<String>    返回类型
	 */
	private List<String> getFinishedActivitiesArray(String processInstanceId) {
		List<String> finishedActivities = new ArrayList<String>();
		...
		for (HistoricTaskInstance hisTask : historicTaskInstances) {
			finishedActivities.add(hisTask.getTaskDefinitionKey());
		}
