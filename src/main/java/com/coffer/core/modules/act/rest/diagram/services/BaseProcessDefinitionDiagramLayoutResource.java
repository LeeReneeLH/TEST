...
public class BaseProcessDefinitionDiagramLayoutResource {
  ...
  public ObjectNode getDiagramNode(String processInstanceId, String processDefinitionId) {
    ...
    for (ActivityImpl activity : processDefinition.getActivities()) {
      getActivity(processInstanceId, activity, activityArray, sequenceFlowArray, 
          processInstance, highLightedFlows, subProcessInstanceMap, bpmnModel);
    }
  ...
  private void getActivity(String processInstanceId, ActivityImpl activity, ArrayNode activityArray, 
      ...
      Map<String, ObjectNode> subProcessInstanceMap, BpmnModel bpmnModel) {
    ...
    for (PvmTransition sequenceFlow : activity.getOutgoingTransitions()) {
      ...
      GraphicInfo flowLabelGraphicInfo = null;
      if (bpmnModel != null) {
    	  flowLabelGraphicInfo = bpmnModel.getLabelGraphicInfo(sequenceFlow.getId());
      } 
      
      if (flowLabelGraphicInfo != null) {
    	  flowJSON.put("flowLabelX", flowLabelGraphicInfo.getX());
          flowJSON.put("flowLabelY", flowLabelGraphicInfo.getY());
          flowJSON.put("flowLabelWidth", flowLabelGraphicInfo.getWidth());
          flowJSON.put("flowLabelHeight", flowLabelGraphicInfo.getHeight());
	  }
