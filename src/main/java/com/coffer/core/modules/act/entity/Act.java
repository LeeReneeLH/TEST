 ...
 */
package com.coffer.core.modules.act.entity;
...
import com.coffer.core.common.persistence.BaseEntity;
import com.coffer.core.common.utils.StringUtils;
import com.coffer.core.common.utils.TimeUtils;
import com.coffer.core.modules.act.utils.Variable;
...
//	private Variable taskVars; 	// 流程任务变量
	...
	public void setProcIns(ProcessInstance procIns) {
		...
		if (procIns != null && procIns.getBusinessKey() != null){
			if (StringUtils.indexOf(procIns.getBusinessKey(), ":") != -1) {
