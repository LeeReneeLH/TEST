 ...
 */
package com.coffer.core.modules.act.utils;
...
import com.coffer.core.common.annotation.FieldName;
...
//	private static Logger logger = LoggerFactory.getLogger(ActUtils.class);
	...
	public static final String ALLOCATION_PBOC_MAIN_TABLE = "PBOC_ALL_ALLOCATE_INFO";
//	/**
//	 * 流程定义Map（自动初始化）
//	 */
