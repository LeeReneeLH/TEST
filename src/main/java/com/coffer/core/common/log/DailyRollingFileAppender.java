package com.coffer.core.common.log;
...
public class DailyRollingFileAppender extends FileAppender {
	 ...
	 * @param layout
	 * @param filename
	 * @param maxBackupIndex 根据配置项取得最大备份数量
	 * @throws IOException
	 */
	public DailyRollingFileAppender(Layout layout, String filename, int maxBackupIndex) throws IOException {
